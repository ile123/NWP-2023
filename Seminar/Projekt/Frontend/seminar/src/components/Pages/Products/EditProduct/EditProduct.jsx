...
export default function EditProduct() {
  ...
  useEffect(() => {
    ...
    .then((data) => {
        setProduct(data);
        setManufactuer(data.manufactuer);
        setType(data.type);
        setColor(data.color);
        setName(data.name);
        setPrice(data.price);
        setPercentageOfAlcohol(data.percentageOfAlcohol);
        setShortDescription(data.shortDescription);
        setImageUrl(data.imageUrl);
      })
    .catch((error) => console.log(error));
  }, [id, userCart.userRole]);
              ...
              <div className="row">
                ...
                <div className="col-md-6 mb-3">
                  <input
                    ...
                    step=".01"
                    className="form-control"
                    defaultValue={product.percentageOfAlcohol}
                ...
                <div className="col-md-6 mb-3">
                  <select
                    name="manufactuer"
                    className="form-select"
                    defaultValue={product.manufactuer}
